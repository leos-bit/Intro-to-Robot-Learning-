...
The baseline PPO curve outperforms the baseline SAC curve, but neither baseline fully solves the task. PPO reaches a best return of about $80.0$, while SAC reaches only about $20.7$ before degrading. Importantly, the PPO and SAC baselines showed little to no sustained improvement from simply training longer; additional training often produced noisy plateaus or regression rather than a clear upward trend. In contrast, Modification 1 improved substantially over longer training, rising to a best return of $366.8$ and the highest success rate. This suggests that the limiting factor was not only training duration, but also whether the reward and termination design gave the policy the right signal for final approach and stabilization. Modification 2 is lower than the best still-air goal-hover policy, but it remains competitive despite wind disturbances, reaching $267.6$ return and $35.9\%$ success.
